...
### Results 
A breakdown of the results for all three random seeds (42, 63, 84) used in the final paper can be found in "Results of transfer learning.xslx". This file contains the source GP results as well as the transfer learning (and baselines) forecasting performance for all eight target farms, stratified by cluster and data capacity.
