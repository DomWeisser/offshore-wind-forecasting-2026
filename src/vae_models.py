...
def extract_vae_features(vae, normalised_vae, device='cuda'):
    ...
    # Use num_workers=0 on CPU to avoid Windows multiprocessing issues
    ...
    dataloader = DataLoader(
        ...
        batch_size=64, 
        shuffle=False, 
        num_workers=use_workers,  # 0 for CPU, 4 for CUDA
        pin_memory=use_pin_memory  # False for CPU, True for CUDA
    )
    latent_codes = []
